...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    $name = strip_tags(trim($_POST["demo-name"]));
    $email = filter_var(trim($_POST["demo-email"]), FILTER_SANITIZE_EMAIL);
    $category = $_POST["demo-category"];
    $priority = $_POST["demo-priority"];
    $message = trim($_POST["demo-message"]);

    // This is where the email will be sent
    $recipient = "ghjuber@gmail.com";
